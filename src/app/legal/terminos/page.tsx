        ...
        <div className="max-w-4xl mx-auto px-6">
          <header className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-7 sm:p-9">
            ...
            <p className="mt-3 text-white/70 leading-relaxed">
              Condiciones generales de uso del sitio y, si aplica, contratación de servicios.
            </p>
          ...
          <div className="mt-8 space-y-6">
            <ArticleCard title="1. Uso del sitio">
              <p className="text-white/75 leading-relaxed">
                Al navegar en este sitio aceptas estos términos. Si no estás de acuerdo, por favor no lo uses.
              </p>
            </ArticleCard>

            <ArticleCard title="2. Servicios">
              <p className="text-white/75 leading-relaxed">
                Web JP ofrece servicios de diseño UX/UI y desarrollo web. El alcance, plazos,
                entregables y pagos se acordarán por escrito en cada propuesta.
              </p>
            </ArticleCard>

            <ArticleCard title="3. Propiedad intelectual">
              <p className="text-white/75 leading-relaxed">
                Salvo pacto distinto, el contenido del sitio y recursos propios de Web JP están protegidos.
                La propiedad/cesión de entregables se define en el acuerdo del proyecto.
              </p>
            </ArticleCard>

            <ArticleCard title="4. Responsabilidad">
              <p className="text-white/75 leading-relaxed">
                Este sitio se ofrece “tal cual”. Web JP no garantiza disponibilidad ininterrumpida
                ni se hace responsable por daños indirectos derivados del uso del sitio.
              </p>
            </ArticleCard>

            <ArticleCard title="5. Enlaces a terceros">
              <p className="text-white/75 leading-relaxed">
                Podemos incluir enlaces a terceros (redes sociales, herramientas). No controlamos su contenido
                ni sus políticas.
              </p>
            </ArticleCard>
            ...
            <ArticleCard title="6. Cambios">
              <p className="text-white/75 leading-relaxed">
                Podremos actualizar estos términos. La versión vigente estará disponible en esta página.
              </p>
            </ArticleCard>
