...
const FAQS = [
  ...
  },
  {
    ...
    a: "Implementación en Next.js, responsive, performance, buenas prácticas, animaciones sutiles, y estructura lista para escalar. También puedo integrar formularios, analítica y otras herramientas.",
  },
  {
    q: "¿Trabajas con pagos por etapas?",
    a: "Sí. Para proyectos más grandes, lo normal es dividir por hitos (diseño, desarrollo, ajustes finales) para que todo sea transparente y controlable.",
  },
  {
