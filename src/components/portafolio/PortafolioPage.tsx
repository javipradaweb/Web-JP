...
const CATEGORIES: Category[] = ["Todos", "Landing", "Corporativo", "Ecommerce", "Sistema"];
...
const PROJECTS: Project[] = [
  {
    ...
    highlights: ["Arquitectura de contenido", "CTA + prueba social", "Optimización de performance"],
  },
  {
    id: "p2",
    ...
    url: "https://tusitio.com",
    highlights: ["Diseño editorial premium", "Estructura clara", "Secciones orientadas a confianza"],
  },
  {
    id: "p3",
...
function ArrowIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden className="text-white/80">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-28 lg:pt-32 pb-12">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="text-xs tracking-[0.22em] text-white/80 font-semibold">PORTAFOLIO</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-white/70">Filtra por tipo de proyecto.</p>
          </div>

          <div className="inline-flex flex-wrap gap-2 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-2">
            {CATEGORIES.map((c) => {
        ...
        >
          <div>
            <h3 className="text-2xl font-semibold text-white">¿Quieres algo así para tu marca?</h3>
            <p className="mt-2 text-sm text-white/75 max-w-xl">
              Cuéntame tu objetivo y armamos una solución clara: UX/UI + desarrollo con performance y foco en resultados.
            </p>
          </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-7 sm:p-8">
                  ...
                  <p className="mt-3 text-sm text-white/75 leading-relaxed">{selected.desc}</p>
