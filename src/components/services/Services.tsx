  ...
  return (
    <section id="servicios" className="relative bg-transparent text-white py-20">
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        {/* ✅ SEO-friendly block (solo texto, no rompe diseño ni lógica) */}
        <motion.div
        ...
        >
          ...
          <p className="mt-4 text-white/80 leading-relaxed">
            ...
            WordPress o desarrollo a medida, según el objetivo del proyecto.
            Cada sitio y aplicación se construye con foco en usabilidad,
            velocidad, SEO y conversión para negocios, marcas personales y
            emprendimientos.
          </p>
        </motion.div>
                ...
                <div className="min-h-full w-full flex items-start justify-center px-4 py-10">
                  ...
                  >
                    <div className="max-h-[calc(100vh-5rem)] overflow-y-auto">
                      ...
                      <div className="px-6 sm:px-8 pb-6 text-xs text-white/45"></div>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
